...
public class TestXMLMultiSourceCloneFragmentDataProvider {
	...
	public static void setup(){
		...
		XMLMultiSourceFragmentDataProviderConfiguration dataProviderConfig = new XMLMultiSourceFragmentDataProviderConfiguration(sourceFragmentFile, transformedSourceFragmentFile, "/Volumes/Data/auni_home/test_systems", CloneFragment.CLONE_GRANULARITY_FUNCTION);
