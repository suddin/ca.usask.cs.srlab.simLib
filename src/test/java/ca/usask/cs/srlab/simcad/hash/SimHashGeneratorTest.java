...
public class SimHashGeneratorTest {
	...
	public static void setup(){
		detectionSettings1 = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_1);
		detectionSettings2 = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_1,  CloneSet.CLONE_TYPE_2,  CloneSet.CLONE_TYPE_3);
	}
