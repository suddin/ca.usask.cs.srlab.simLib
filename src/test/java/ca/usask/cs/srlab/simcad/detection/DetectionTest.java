...
public class DetectionTest {
	...
	public static void setup(){
		detectionSettings_type1_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP, SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, true, CloneSet.CLONE_TYPE_1);
		detectionSettings_type2_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_2);
		detectionSettings_type3_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_3);
		detectionSettings_type12_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_12);
		detectionSettings_type23_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_23);
		detectionSettings_type13_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, false, CloneSet.CLONE_TYPE_13);
		detectionSettings_type123_group = new DetectionSettings(SimCadConstants.LANGUAGE_JAVA, CloneFragment.CLONE_GRANULARITY_FUNCTION, SimCadConstants.CLONE_SET_TYPE_GROUP,  SimCadConstants.SOURCE_TRANSFORMATION_APPROACH_GENEROUS, true,  CloneSet.CLONE_TYPE_123);
...
//		//ICloneFragmentDataProvider cloneFragmentDataProvider = new XMLCloneFragmentDataProvider(dataProviderConfig, detectionSettings_type1);
		...
		XMLMultiSourceFragmentDataProviderConfiguration dataProviderConfig = new XMLMultiSourceFragmentDataProviderConfiguration(sourceFragmentFile, transformedSourceFragmentFile, "/Volumes/Data/auni_home/test_systems/dnsjava/dnsjava-0-3", CloneFragment.CLONE_GRANULARITY_FUNCTION);
		dataProviderConfig.addDataTransformer(new FixTxlSourceFragmentOutputXML());
