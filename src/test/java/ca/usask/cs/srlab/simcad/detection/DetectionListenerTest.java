...
public class DetectionListenerTest {
	...
	public static void setup(){
		...
		XMLMultiSourceFragmentDataProviderConfiguration dataProviderConfig = new XMLMultiSourceFragmentDataProviderConfiguration(sourceFragmentFile, transformedSourceFragmentFile,Environment.getResourcePath(""), CloneFragment.CLONE_GRANULARITY_FUNCTION);
