...
public abstract class CloneFragment implements ICloneFragment, Cloneable {
	...
	public static final String CLONE_GRANULARITY_FUNCTION 	= SimCadConstants.CLONE_GRANULARITY_FUNCTION;
	public static final String CLONE_GRANULARITY_BLOCK 	= SimCadConstants.CLONE_GRANULARITY_BLOCK;
...
//	}
	...
	@Transient
	public boolean isSubsumedBy(CloneFragment otherFragment) {
		if (otherFragment.fileName.equals(fileName)
				&& otherFragment.fromLine <= fromLine
				&& otherFragment.toLine >= toLine)
			return true;
		return false;
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof CloneFragment) {
			...
			return another.fileName.equals(fileName)
					&& another.fromLine.equals(fromLine) 
					&& another.toLine.equals(toLine)
					&& another.simhash1.equals(simhash1)
					&& another.simhash2.equals(simhash2)
					&& another.isInjected == isInjected;
		}
		return false;
	}
	...
	public int hashCode() {
		...
		h = 31 * h + simhash2.intValue();
		h = 31 * h + (isInjected? 13 : 0);
		return h;
	}
