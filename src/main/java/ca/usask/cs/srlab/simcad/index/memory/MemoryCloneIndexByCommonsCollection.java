...
public class MemoryCloneIndexByCommonsCollection extends AbstractInMemoryCloneIndex {
	...
	public MemoryCloneIndexByCommonsCollection(String sourceLocation, String sourceLanguage, String fragmentType, String transformationType) {
	...
	public Set<IndexKey> getAllKeys() {
		Set sortedSet = new TreeSet<IndexKey>(new IndexKeyComparator());
		sortedSet.addAll(lineBitIndex.keySet());
		return sortedSet;
